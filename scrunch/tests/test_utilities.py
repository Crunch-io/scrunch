...
class TestUtilities(object):
    ...
    def test_get_connection_with_ini(self, connect_mock):
        ...
        assert connect_mock.mock_calls[0].kwargs == {
            "site_url": site,
            "username": user,
            "pw": pw,
        }
    ...
    def test_get_dataset(self, root):
        ...
        shoji_entity = {
            "element": "shoji:entity",
            "body": {"id": "123456", "name": "dataset_name", "streaming": "no"},
            "catalogs": {"variables": "variables/"},
        }
        ...
        by_name_catalog = shoji.Catalog(
            ...
            index=shoji.Index(
                session,
                catalog_url,
                **{dataset_url: shoji.Tuple(session, dataset_url, name="dataset_name")}
            ),
        )
        ...
        root.follow.assert_called_with("datasets_by_name", {"name": "dataset_name"})
    ...
    def test_get_dataset_from_project_no_name(self, session):
        ...
        shoji_entity = {
            "element": "shoji:entity",
            "body": {"id": dataset_id, "name": "dataset_name", "streaming": "no"},
        }
        ...
        session.session.get.assert_called_with(
            "https://test.crunch.io/api/b2c4c6b7d3a94e58937b23c1fed1b65e/"
        )
    ...
    def test_get_project(self, session):
        shoji_entity = {
            ...
            "body": {"name": "Y Team", "id": "614a7b2ebe9a4292bba54edce83563ae"},
        }
    ...
    @mock.patch("pycrunch.session")
    @mock.patch(
        "scrunch.datasets.Project.get_child", side_effect=mocked_project_get_child
    )
    ...
    def test_get_project_by_id(self, session):
        ...
        assert str(excinfo.value) == "'Project (name or id: invalidid) not found.'"
    ...
    def test_get_user(self, session):
        shoji_entity = {
            "element": "shoji:catalog",
            "body": {"name": "Heisenberg", "email": "heisenberg@sc.org"},
        }
    ...
    def test_user_agent(self):
        ...
        assert prep_req.headers["user-agent"] == "scrunch/%s (pycrunch/%s)" % (
            scrunch.__version__,
            pycrunch_v,
        )
