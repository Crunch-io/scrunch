...
class TestProjectNesting(TestCase):
    def test_detect_correct_handler(self):
        ...
        datasets_catalog = Catalog(session, index={}, order=dataset_order)
        shoji_resource = Entity(
            session, self="/project/url/", body={}, index={}, datasets=datasets_catalog
        )
        ...
        shoji_resource = Entity(
            session, self="/project/url/", body={}, index={}, graph=[]
        )
        project = Project(shoji_resource)
    ...
    def test_create_subproject(self):
        ...
        shoji_resource = Entity(
            session, self="http://example.com/project/url/", body={}, index={}, graph=[]
        )
        ...
        response.headers = {"Location": created_project_url}
        session.add_post_response(response)
        session.add_fixture(
            created_project_url,
            {"self": created_project_url, "body": {}, "index": {}, "graph": []},
        )
        project = Project(shoji_resource)
        ...
        self.assertEqual(
            ...
            {"element": "shoji:entity", "body": {"name": "Project A"}},
        )
    ...
    def make_tree(self):
        ...
        a_payload = {
            ...
            "self": a_res_url,
            "catalogs": {"project": "http://example.com/api/projects/"},
            "body": {"name": "project A"},
            "index": {
                b_res_url: {
                    "id": "idB",
        ...
        projects_catalog = {
            ...
            "index": {a_res_url: {"name": "project A"}},
        }
    ...
    def test_move_things(self):
        ...
        self.assertEqual(
            json.loads(patch_request.body),
            {
                "element": "shoji:entity",
                "body": {},
                "index": {project_c.url: {}, dataset.url: {}},
    ...
    def test_move_project(self):
        ...
        self.assertEqual(index, {project_d.url: {}})
    ...
    def test_children(self):
        ...
        self.assertEqual([c.url for c in project_a.children], project_a.resource.graph)
...
class TestPersonalProject(TestCase):
    ...
    def _get_root(self):
        ...
        session.add_fixture(
            projects_url,
            {
                "self": projects_url,
                "element": "shoji:catalog",
                "catalogs": {"personal": self.PERSONAL_URL},
                "index": {},
            },
        )
        session.add_fixture(
            self.PERSONAL_URL,
            {"self": self.PERSONAL_URL, "element": "shoji:catalog", "index": {}},
        )
        response = Response()
    ...
    def test_move_to_personal(self):
        ...
        self.assertEqual(patch_request.method, "PATCH")
        self.assertEqual(json.loads(patch_request.body)["index"], {project_a.url: {}})
