...
class TestScripts(TestCase):
    def test_create_script(self):
        ...
        session.add_fixture(
            scripts_url, {"element": "shoji:catalog", "self": scripts_url, "index": {}}
        )
        session.add_fixture(
            created_script_url, {"self": created_script_url, "body": {}}
        )
        ...
        self.assertEqual(
            json.loads(post_request.body),
            {
                ...
                "body": {"body": "<script body>", "strict_subvariable_syntax": False},
            },
        )
    ...
    def test_collapse_scripts(self):
        ...
        session.add_fixture(
            collapse_url, {"element": "shoji:view", "self": collapse_url, "value": {}}
        )
        session.add_post_response(response)
