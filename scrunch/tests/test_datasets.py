    ...
    def __init__(self, d):
        for a, b in d.items():
            if isinstance(b, (list, tuple)):
                setattr(
                    self, a, [dict_to_obj(x) if isinstance(x, dict) else x for x in b]
                )
            else:
...
class TestDatasets(TestDatasetBase, TestCase):
    ...
    def test_replace_values_sync(self, mocked_process):
        ...
        variables = {
            ...
            "002": {"id": "002", "alias": "level", "name": "Level", "type": "numeric"},
        }
                ...
                "body": {
                    ...
                    "derivation": {
                        ...
                        "args": [
                            {
                                "function": "*",
                                "args": [{"variable": "weekly_rent"}, {"value": 52}],
                            },
                            {"value": 12},
                        ],
                    },
    ...
    def test_derive_weight(self):
        variables = {
            "001": {"id": "001", "alias": "foo", "name": "bar", "type": "numeric"}
        }
        ds_mock = self._dataset_mock(variables=variables)
        ds = MutableDataset(ds_mock)
...
class TestExclusionFilters(TestDatasetBase, TestCase):
    ...
    def test_remove_exclusion(self):
        ...
        ds.resource.session.patch.assert_called_once_with(
            ds.resource.fragments.exclusion, data=json.dumps({"expression": {}})
        )
    ...
    def test_in(self):
        ...
        expected_expr_obj = {
            "expression": {
                "function": "in",
                "args": [{"variable": var.url}, {"value": [32766]}],
            }
        }
    ...
    def test_in_multiple(self):
        ...
        expected_expr_obj = {
            "expression": {
                "function": "in",
                "args": [{"variable": var.url}, {"value": [32766, 32767]}],
            }
        }
    ...
    def test_not_and(self):
        variables = {
            "0001": dict(
                id="0001", alias="disposition", name="Disposition", type="numeric"
            ),
            "0002": dict(id="0002", alias="exit_status", name="Exit", type="numeric"),
        }
        ...
        data = self._exclude_payload(
            ds, "not (disposition in (1, 2) and exit_status == 0)"
        )
        expected_expr_obj = {
            "expression": {
                "function": "not",
                "args": [
                    {
                        ...
                        "args": [
                            {
                                "function": "in",
                                "args": [{"variable": var1.url}, {"value": [1, 2]}],
                            },
                            {
                                "function": "==",
                                "args": [{"variable": var2.url}, {"value": 0}],
                            },
                        ],
                    }
                ],
    ...
    def test_all_or_all(self):
        ...
        expected_expr_obj = {
            "expression": {
                "args": [
                    {
                        "args": [{"variable": var.url}, {"value": [1]}],
                        "function": "all",
                    },
                    {
                        "args": [{"variable": var.url}, {"value": [2]}],
                        "function": "all",
                    },
                ],
                "function": "or",
    ...
    def test_not_all_or_all(self):
        ...
        data = self._exclude_payload(
            ds, "not(var1_alias.all([1]) or var1_alias.all([2]))"
        )
        expected_expr_obj = {
            "expression": {
                "function": "not",
    ...
    def test_duplicates(self):
        ...
        expected_expr_obj = {
            "expression": {"function": "duplicates", "args": [{"variable": var.url}]}
        }
    ...
    def test_valid(self):
        ...
        expected_expr_obj = {
            "expression": {"function": "is_valid", "args": [{"variable": var.url}]}
        }
    ...
    def test_not_valid(self):
        ...
        expected_expr_obj = {
            "expression": {
                "args": [{"args": [{"variable": var.url}], "function": "is_valid"}],
                "function": "not",
            }
        }
    ...
    def test_missing(self):
        ...
        expected_expr_obj = {
            "expression": {"args": [{"variable": var.url}], "function": "is_missing"}
        }
    ...
    def test_not_missing(self):
        ...
        expected_expr_obj = {
            "expression": {
                "function": "not",
                "args": [{"function": "is_missing", "args": [{"variable": var.url}]}],
            }
        }
    ...
    def test_nested(self):
        ...
        data = self._exclude_payload(
            ds,
            "(disposition != 1 and (not valid(exit_status) or exit_status >= 1)) or (disposition == 0 and exit_status == 0) or (disposition == 0 and exit_status == 1)",
        )
        expected_expr_obj = {
            "expression": {
                "args": [
                    {
                        "args": [
                            {
                                "args": [{"variable": var1.url}, {"value": 1}],
                                "function": "!=",
                            },
                            {
                                "args": [
                                    ...
                                    {
                                        "args": [{"variable": var2.url}, {"value": 1}],
                                        "function": ">=",
                                    },
                                ],
                                "function": "or",
                        ...
                        "args": [
                            {
                                "args": [
                                    {
                                        "args": [{"variable": var1.url}, {"value": 0}],
                                        "function": "==",
                                    },
                                    {
                                        "args": [{"variable": var2.url}, {"value": 0}],
...
class TestVariables(TestDatasetBase, TestCase):
    def test_variable_as_member(self):
        ...
        assert (
            str(err.value)
            == "Entity %s has no (sub)variable with a name or alias some_variable"
            % ds.name
        )
    ...
    def test_edit_resolution(self):
        variables = {
            "001": {
                ...
                "type": "datetime",
                "is_subvar": False,
                "view": {"rollup_resolution": "ms", "width": 10},
            }
        }
        ds_mock = self._dataset_mock(variables=variables)
        ds = MutableDataset(ds_mock)
        ...
        var.resource._edit.assert_called_with(
            view={"rollup_resolution": "M", "width": 10}
        )
    ...
    def test_add_category(self):
        ...
        var.resource._edit.assert_called_with(
            categories=var.resource.body["categories"]
        )
    ...
    def test_update_missing_rules(self):
        ...
        assert json.loads(args[1]) == {
            "rules": {"skipped": {"value": 9}, "not asked": {"value": 8}}
        }
...
class TestCurrentEditor(TestDatasetBase, TestCase):
    ...
    def test_change_editor_email(self, mocked_get_user):
        ...
        response.payload = {"index": {self.user_url: {"email": "jane.doe@crunch.io"}}}
        ...
        ds_res.patch.assert_called_with(
            {"element": "shoji:entity", "body": {"current_editor": self.user_url}}
        )
...
class TestCurrentOwner(TestDatasetBase, TestCase):
    ...
    def test_change_owner(self, mocked_get_user):
        ...
        ds_mock.patch.assert_called_with({"owner": self.user_url})
    ...
    def test_owner_to_project(self):
        ...
        mock_warn.assert_has_calls(
            [
                mock.call(
                    "Use Dataset.move() to move datasets between projects",
                    DeprecationWarning,
                )
            ]
        )
...
class TestCast(TestCase):
    ...
    def test_cast_not_allowed(self):
        ...
        with pytest.raises(AssertionError) as excinfo:
            ...
            ds_res.resource.session.post.assert_called_with({"cast_as": "not_allowed"})
...
class TestSavepoints(TestCase):
    ...
    def test_create_savepoint(self):
        ...
        ds_res.savepoints.create.assert_called_with(
            {
                "element": "shoji:entity",
                "body": {"description": "savepoint description"},
            }
        )
    ...
    def test_create_savepoint_keyerror(self):
        ...
        ds_res = MagicMock(session=sess)
        ds_res.savepoints = MagicMock()
        ds_res.savepoints.index = {1: {"description": "savepoint description"}}
        ds = StreamingDataset(ds_res)
...
class TestForks(TestCase):
    ...
    def test_fork_preserve_owner(self):
        ...
        sess = MagicMock()
        body = JSONObject(
            {"name": "ds name", "description": "ds description", "owner": user_id}
        )
        ds_res = MagicMock(session=sess, body=body)
        ds_res.forks = MagicMock()
        ds_res.forks.index = {}
    ...
    def test_delete_forks(self):
        ...
        ds_res = MagicMock(session=sess)
        ds_res.forks = MagicMock()
        ds_res.forks.index = {"abc1": f1, "abc2": f2, "abc3": f3}
    ...
    def test_merge_fork(self):
        ...
        ds_res = MagicMock(session=sess, body=body)
        ds_res.forks.index = {
            fork1_url: {"name": "FORK #1 of ds name", "id": "abc"},
            fork2_url: {"name": "myFork", "id": "def"},
            fork3_url: {"name": "myFork", "id": "ghi"},
        }
        ...
        expected_call = {
            "element": "shoji:entity",
            "body": {"dataset": fork1_url, "autorollback": True},
        }
        ...
        error_msg = "Couldn't find a (unique) fork. " "Please try again using its id"
...
class TestFillVariables(TestCase):
    def prepare_ds(self):
        ...
        variables_payload = {
            ...
            "self": variables_url,
            "index": {
                "001": {"alias": "var_a", "type": "categorical", "id": "001"},
                "002": {"alias": "var_b", "type": "categorical", "id": "002"},
                new_var_url: {"alias": "filled", "type": "categorical", "id": "123"},
            },
        }
        table_payload = {
            "element": "crunch:table",
        ...
        new_var_payload = {
            "element": "shoji:entity",
            "self": new_var_url,
            "body": {"name": "Filled var", "alias": "filled", "type": "categorical"},
        }
        ...
        response.headers = {"Location": new_var_url}
    ...
    def test_recode_w_fill(self):
        ...
        fill_expr = {
            ...
            "args": [
                case_expr,
                {"map": {"1": {"variable": "001"}, "2": {"variable": "002"}}},
            ],
        }
    ...
    def test_else_code(self):
        ...
        fill_expr = {
            "function": "fill",
            "args": [case_expr, {"map": {"1": {"variable": "001"}}}],
        }
        self.assertEqual(
    ...
    def test_else_var(self):
        ...
        fill_expr = {
            ...
            "args": [
                case_expr,
                {"map": {"1": {"variable": "001"}, "-1": {"variable": "002"}}},
            ],
        }
        self.assertEqual(
            json.loads(post_request.body),
                                            ...
                                            "0001": {
                                                ...
                                                "args": [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "args": [
                                                            {
                                                                "variable": "https://test.crunch.io/api/datasets/123456/variables/%s/"
                                                                % variables["var_a"][
                                                                    "id"
                                                                ]
                                                            },
            ...
            "subvariables": [
                {
                    "id": 1,
                    "name": "Facebook",
                    "cases": {1: "var_a == 1", 2: "var_a == 2"},
                },
                {
                    "id": 2,
                    "name": "Twitter",
                    "cases": {1: "var_b == 1", 2: "var_b == 2"},
                },
                {
                    "id": 3,
                    "name": "Google+",
                    "cases": {1: "var_c == 1", 2: "var_c == 2"},
                },
            ],
        }
        with pytest.raises(ValueError) as err:
                        ...
                        "args": [
                            {
                                "map": {
                                    "00001": {
                                        ...
                                        "args": [{"variable": "../original_variable"}],
                                    }
                                }
                            }
                        ],
...
class TestProjectsHierarchicalOrder(TestCase):
    ...
    def test_element_str_representation(self):
        ...
        assert str(proj.order) == json.dumps(
            [{"GroupA": []}, "test_dataset1", "test_dataset2"],
...
class TestDatasetsHierarchicalOrder(TestCase):
    ...
    def setUp(self):
        variable_defs = [
            AttributeDict(
                id="000001", alias="id", name="ID", type="numeric", is_subvar=False
            ),
            AttributeDict(
                id="000002",
                alias="hobbies",
            ...
            AttributeDict(
                id="000007", alias="gender", name="Gender", type="text", is_subvar=False
            ),
            AttributeDict(
                id="000008",
                alias="country",
            ...
            AttributeDict(
                id="000009", alias="city", name="City", type="text", is_subvar=False
            ),
            AttributeDict(
                id="000010",
                alias="zip_code",
            ...
            AttributeDict(
                id="000012", alias="music", name="Music", type="text", is_subvar=False
            ),
            AttributeDict(
                id="000013",
                alias="religion",
        ...
        index = {
            "%svariables/%s/" % (self.ds_url, var["id"]): var for var in variable_defs
        }
            ...
            [
                ...
                "Hobbies",
                {
                    "Account": [
                        "Registration Time",
                        "Last Login Time",
                        {"User Information": ["First Name", "Last Name", "Gender"]},
                        {"Location": ["Country", "City", "Zip Code", "Address"]},
                    ]
                },
                "Music",
                "Religion",
    ...
    def test_group_level_reordering(self):
        ...
        ds.order["|Account"].reorder(
            ["User Information", "Location", "registration_time", "last_login_time"]
        )
        assert (
            self._get_update_payload(ds)
            == {
    ...
    def test_group_creation(self):
        ...
        ds.order["|Account"].create_group(
            "Gewürze / Inhaltsstoffe", alias=["music", "religion"]
        )
        ...
        ds.order["|Account|User Information"].create_group(
            "PII", alias=["first_name", "last_name"], after="gender"
        )
        ...
        ds.order["|Account|Location"].create_group(
            "PII", alias=["address"], before="zip_code"
        )
    ...
    def test_move_variable(self):
        ...
        assert (
            self._get_update_payload(var.dataset)
            == {
                "element": "shoji:order",
                "graph": [
                    "http://test.crunch.local/api/datasets/123/variables/000002/",  # hobbies
...
class TestDatasetJoins(TestCase):
    ...
    def test_dataset_joins(self):
        ...
        left_ds.resource.variables.post.assert_called_once_with(expected_payload)
    ...
    def test_dataset_joins_column_urls(self):
        ...
        with mock.patch("scrunch.mutable_dataset.wait_progress"):
            left_ds.join("id", right_ds, "id", ["id"])
        call_payload = left_ds.resource.variables.post.call_args[0][0]
        expected_payload = {"map": {right_var.url: {"variable": right_var.url}}}
...
class TestDatasetExport(TestCase):
    ...
    def test_basic_csv_export(self, export_ds_mock, dl_file_mock):
        ...
        assert export_options == {"options": {"use_category_ids": True}}
    ...
    def test_csv_export_options(self, export_ds_mock, dl_file_mock):
        ...
        assert export_format == "csv"
        assert export_options == {"options": {"use_category_ids": False}}
    ...
    def test_basic_spss_export(self, export_ds_mock, dl_file_mock):
        ...
        assert export_options == {
            "options": {"prefix_subvariables": False, "var_label_field": "description"}
        }
    ...
    def test_spss_export_options(self, export_ds_mock, dl_file_mock):
        ...
        ds.export(
            "export.sav",
            format="spss",
            options={"prefix_subvariables": True, "var_label_field": "name"},
        )
        ...
        assert export_format == "spss"
        assert export_options == {
            "options": {"var_label_field": "name", "prefix_subvariables": True}
        }
    ...
    def test_invalid_spss_export_options(self, export_ds_mock, _):
        ...
        with pytest.raises(ValueError):
            ds.export("export.csv", format="spss", options={"invalid_option": False})

        with pytest.raises(ValueError):
            ds.export(
                "export.csv", format="spss", options={"var_label_field": "invalid"}
            )
...
class TestVariableIterator(TestDatasetBase):
    ...
    def test_subvar_order(self):
        subvars_order = ["0001", "0002", "0003", "0004"]
        subvars = {
            # Intentionally unordered
            "0003": {"id": "0003", "alias": "subvar_3"},
            "0001": {"id": "0001", "alias": "subvar_1"},
            "0004": {"id": "0004", "alias": "subvar_4"},
            "0002": {"id": "0002", "alias": "subvar_2"},
        }
...
class TestMultitable(TestDatasetBase, TestCase):
    ...
    def test_multitable_accessor(self):
        ...
        Multitable(mt, ds)
        assert isinstance(ds.multitables, dict)
    ...
    def test_export_tabbook(self):
        ...
        with pytest.raises(AttributeError):
            mockmulti.export_tabbook(
                format="xlsx", where=["var1_alias"], weight="var1_alias"
            )
...
class TestHeadingSubtotals(TestDatasetBase):
    ...
    def test_add_subtotal_difference(self):
        ...
        var.add_subtotal_difference(
            "F - M", add=["Female"], subtract=["Male"], anchor="bottom"
        )
        var.resource.patch.assert_called_once_with(expected_payload)
    ...
    def test_add_multiple_subtotal_difference(self):
        ...
        variable_body = {
            ...
            "body": {
                ...
                "name": "my_var",
                "type": "categorical",
                "categories": [{"id": 1, "name": "Male"}, {"id": 2, "name": "Female"}],
                "view": {
                    "transform": {
        ...
        variable.add_subtotal_difference(
            "M - F", add=["Male"], subtract=["Female"], anchor="top"
        )
...
class TestSubvariableCodes:
    ...
    def test_bind_categorical_array_with_codes(self):
        ...
        dataset.bind_categorical_array(
            "My Array", "my_array", subvariables, subvariable_codes=subvariable_codes
        )
    ...
    def test_copy_variable_no_codes(self):
        ...
        subvars_index = {
            "%s001/" % var_url: {"alias": "var_1", "name": "Subvariable 1"},
            "%s002/" % var_url: {"alias": "var_2", "name": "Subvariable 2"},
            "%s003/" % var_url: {"alias": "var_3", "name": "Subvariable 3"},
        }
        subvariables_catalog = MagicMock(index=subvars_index)
        mock_session = MockSession()
        tuple_members = {"derived": False}
        var_members = {
            "self": var_url,
            "body": {
                "derived": False,
        ...
        assert args == [
            {
                "element": "shoji:entity",
                "body": {"name": "copied", "alias": "copied", "derivation": expression},
            }
        ]
    ...
    def test_copy_variable_with_codes(self):
        ...
        subvariable_codes = ["code_1", "code_2", "code_3"]
        _ = dataset.copy_variable(
            variable, "copied", "copied", subvariable_codes=subvariable_codes
        )
        subreferences = [
