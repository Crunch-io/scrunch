        ...
        responses = [
            {
                ...
                "combined_ids": [
                    ...
                    for sv_alias in (
                        combined_ids
                        if isinstance(combined_ids, _supported_iterable_types)
                        else [combined_ids]
                    )
                ],
            }
    ...
    combinations = [
        {
            ...
            if isinstance(combined_ids, (list, tuple))
            else [combined_ids],
        }
...
def combine_responses_expr(variable_url, responses):
    return {
        ...
        "args": [{"variable": variable_url}, {"value": responses}],
    }
...
def combine_categories_expr(variable_url, combinations):
    return {
        ...
        "args": [{"variable": variable_url}, {"value": combinations}],
    }
